...
#                 items[specimen_name] = get_results(specimen.id, item.discipline, result_statuses=result_statuses)
...
#                         primary = "Y"
#                     if result_id in form.supplementary_result_id.data:
#                         supplementary = "Y"
...
#                     result['supplementary_result'] = supplementary
#                     result['observed_result'] = observed
#                     result['qualitative_result'] = qualitative
#                     result['order'] = result_id_orders.index(result_id) + 1
