...
from lims.sequence_constituents.forms import Add, Edit, Approve, Update
from lims.sequence_constituents.functions import get_form_choices

# Set item global variables
item_type = 'Sequence Constituent'
item_name = 'Sequence Constituents'
table = SequenceConstituents
table_name = 'sequence_constituents'
...
def get_constituents():
    ...
    print(f'SOLUTION: {solution.constituents}')
