...
from lims.models import Preservatives
from lims.preservatives.forms import Add, Edit, Approve, Update
from lims.view_templates.views import *

# Set item global variables
item_type = 'Preservative'
item_name = 'Preservatives'
table = Preservatives
table_name = 'preservatives'
