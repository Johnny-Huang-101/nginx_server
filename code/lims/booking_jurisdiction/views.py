...
from lims.booking_jurisdiction.forms import Add, Edit, Approve, Update

# Set item global variables
item_type = 'Booking Jurisdiction'  # singular
item_name = 'Booking Jurisdiction'
table = BookingJurisdiction
table_name = 'booking_jurisdiction'
