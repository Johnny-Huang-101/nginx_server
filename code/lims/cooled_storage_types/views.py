...
from lims.models import CooledStorageTypes
from lims.cooled_storage_types.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'Cooled Storage Type'  # singular
item_name = 'Cooled Storage Types'
table = CooledStorageTypes
table_name = 'cooled_storage_types'
