from lims import db
from lims.models import Statuses, EvidenceStorageTypes
...
def get_form_choices(form):
    ...
    form.evidence_storage_type.choices = [(item.id, item.name) for item in EvidenceStorageTypes.query.all()]
    form.evidence_storage_type.choices.insert(0, (0, 'Please select a type'))
