...
from lims.models import HistologyEquipmentTypes
from lims.histology_equipment_types.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'Histology Equipment Type'  # singular
item_name = 'Histology Equipment Types'
table = HistologyEquipmentTypes
table_name = 'histology_equipment_types'
