...
from lims.models import SampleFormats
from lims.sample_formats.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'Sample Format'  # singular
item_name = 'Sample Formats'
table = SampleFormats
table_name = 'sample_formats'
