...
from lims.models import HoodTypes
from lims.hood_types.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'Hood Type'  # singular
item_name = 'Hood Types'
table = HoodTypes
table_name = 'hood_types'
