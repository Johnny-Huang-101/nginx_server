...
from lims.models import ServiceTypes
from lims.forms import Attach, Import
from lims.view_templates.views import *
from lims.service_types.forms import Add, Edit, Approve, Update

# Set item global variables
item_type = 'Service Type'  # singular
item_name = 'Service Types'
table = ServiceTypes
