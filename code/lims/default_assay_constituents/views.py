...
from lims.default_assay_constituents.forms import Add, Edit, Approve, Update
from lims.default_assay_constituents.functions import get_form_choices

# Set item global variables
item_type = 'Default Assay Constituent'
item_name = 'Default Assay Constituents'
table = DefaultAssayConstituents
table_name = 'default_assay_constituents'
