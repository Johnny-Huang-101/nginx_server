...
from lims.drug_monographs.forms import Add, Edit, Approve, Update

# Set item global variables
item_type = 'Drug Monograph'
item_name = 'Drug Monographs'
table = DrugMonographs
table_name = 'drug_monographs'
...
def view(item_id):
    ...
    #alias = f"{getattr(getattr(item, 'compound'), 'name')}"
