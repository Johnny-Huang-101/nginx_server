...
from lims.models import EvidenceStorageTypes
from lims.evidence_storage_types.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'Evidence Storage Type'  # singular
item_name = 'Evidence Storage Types'
table = EvidenceStorageTypes
table_name = 'evidence_storage_types'
