...
from lims.divisions.forms import Add, Edit, Approve, Update
from lims.divisions.functions import get_form_choices, process_form
...
disable_fields = ['emails']  # fields to disable
...
def view(item_id):
    ...
    personnel = Personnel.query.filter_by(division_id=item_id).order_by(Personnel.full_name)

    _view = view_item(item, alias, item_name, table_name, personnel=personnel)
    return _view
