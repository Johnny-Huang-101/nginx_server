...
from lims.zipcodes.forms import Add, Edit, Approve, Update
...
table = Zipcodes
table_name = 'zipcodes'
name = 'zipcode'  # This selects what property is displayed in the flash messages
...
@login_required
def view_list():
    _view_list = view_items(table, item_name, item_type, table_name, order_by=['zipcode'])
