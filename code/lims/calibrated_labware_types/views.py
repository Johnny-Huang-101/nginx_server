...
from lims.models import CalibratedLabwareTypes
from lims.calibrated_labware_types.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'Calibrated Labware Type'  # singular
item_name = 'Calibrated Labware Types'
table = CalibratedLabwareTypes
table_name = 'calibrated_labware_types'
