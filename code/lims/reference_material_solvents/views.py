...
from lims.models import RefMatSolvents
from lims.reference_material_solvents.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'Reference Material Solvent'
item_name = 'Reference Material Solvents'
table = RefMatSolvents
table_name = 'reference_material_solvents'
