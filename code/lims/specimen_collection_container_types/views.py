...
from lims.specimen_collection_container_types.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'Collection Vessel Type'  # singular
item_name = 'Collection Vessel Types'
table = SpecimenCollectionContainerTypes
table_name = 'specimen_collection_container_types'
