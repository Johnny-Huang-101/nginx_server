...
from lims.models import BatchCommentsReference
from lims.batch_comments_reference.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *


# Set item global variables
item_type = 'Reference Batch Comment'  # singular
item_name = 'Reference Batch Comments'
table = BatchCommentsReference
table_name = 'batch_comments_reference'
