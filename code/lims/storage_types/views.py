...
from lims.models import StorageTypes
from lims.storage_types.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'Storage Type'  # singular
item_name = 'Storage Types'
table = StorageTypes
table_name = 'storage_types'
