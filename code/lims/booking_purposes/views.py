...
from lims.booking_purposes.forms import Add, Edit, Approve, Update

# Set item global variables
item_type = 'Booking Purpose'  # singular
item_name = 'Booking Purposes'
table = BookingPurposes
table_name = 'booking_purposes'
