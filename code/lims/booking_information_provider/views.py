from lims.models import BookingInformationProvider
from lims.booking_information_provider.forms import Add, Edit, Approve, Update
from lims.booking_information_provider.functions import get_form_choices
from lims.forms import Attach, Import
from lims.view_templates.views import *


# Set item global variables
item_type = 'Booking Information Provider'
item_name = 'Booking Information Provider'
table = BookingInformationProvider
table_name = 'booking_information_provider'
