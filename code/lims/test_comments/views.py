...
from lims.test_comments.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.test_comments.functions import get_form_choices
from lims.view_templates.views import *

# Set item global variables
item_type = 'Test Comment'
item_name = 'Test Comments'
table = TestComments
...
@blueprint.route(f'/{table_name}/<int:test_id>/add_comment', methods=['GET', 'POST'])
@login_required
def add_test_comment(test_id):
    kwargs = default_kwargs.copy()
    ...
    if form.is_submitted() and form.validate():
        ...
        return redirect(url_for('tests.view_comments', item_id=test_id))
