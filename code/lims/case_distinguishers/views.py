...
from lims.case_distinguishers.forms import Add, Edit, Approve, Update
from lims.case_distinguishers.functions import get_form_choices
from lims.forms import Attach, Import
from lims.models import CaseDistinguishers
from lims.view_templates.views import *

# Set Item Global Variables
item_type = 'Case Distinguisher'
item_name = 'Case Distinguishers'
table_name = 'case_distinguishers'
table = CaseDistinguishers
...
def add():
    ...
    if request.method == 'POST':
        for case_type_id in form.case_type_id.data:
            kwargs['case_type_id'] = case_type_id
            if case_type_id != form.case_type_id.data[-1]:
