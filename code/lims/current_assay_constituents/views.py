...
from lims.models import CurrentAssayConstituents
from lims.current_assay_constituents.forms import Add, Edit, Approve, Update
from lims.current_assay_constituents.functions import get_form_choices
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'Assay Constituent'
item_name = 'Assay Constituents'
table = CurrentAssayConstituents
table_name = 'current_assay_constituents'
