...
from lims.models import SpecimenConditions
from lims.specimen_conditions.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Item Global Variables
item_type = 'Specimen Condition'
item_name = 'Specimen Conditions'
table = SpecimenConditions
table_name = "specimen_conditions"
