from lims import db
from lims.models import Divisions, Statuses, CalibratedLabwareTypes, Agencies
...
def get_form_choices(form):
    ...
    form.type_id.choices = [(item.id, item.name) for item in CalibratedLabwareTypes.query.all()]
