...
from lims.record_types.forms import Add, Edit, Approve, Update
from lims.record_types.functions import get_form_choices
...
@login_required
def view_list():
    _view_list = view_items(table, item_name, item_type, table_name, order_by=['suffix'])
