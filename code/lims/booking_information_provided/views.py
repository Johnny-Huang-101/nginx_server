from lims.models import BookingInformationProvided
from lims.booking_information_provided.forms import Add, Edit, Approve, Update
from lims.booking_information_provided.functions import get_form_choices
from lims.forms import Attach, Import
from lims.view_templates.views import *


# Set item global variables
item_type = 'Booking Discussion Topic'
item_name = 'Booking Discussion Topic'
table = BookingInformationProvided
table_name = 'booking_information_provided'
