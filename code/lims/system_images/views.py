...
from lims.system_images.forms import Add, Edit, Approve, Update
from lims.system_images.functions import picture_handler
import os
from PIL import Image

# Set item variables
item_type = 'System Images'
item_name = 'System Images'
table = SystemImages
table_name = 'system_images'
name = 'name'
...
def add():
    ...
    if form.is_submitted() and form.validate():
        if form.image_file.data:
            picture_handler(form.image_file.data, path)
