...
from lims.comments.forms import Add, Edit, Approve, Update

# Set item global variables
item_type = 'Comment'  # singular
item_name = 'Comments'
table = Comments
table_name = 'comments'
name = 'comment'  # This selects what property is displayed in the flash messages
