...
from lims.evidence_comments_reference.forms import Add, Edit, Approve, Update
from lims.evidence_comments_reference.functions import get_form_choices

# Set item global variables
item_type = 'Evidence Comments Reference'
item_name = 'Evidence Comments Reference'
table = EvidenceCommentsReference
table_name = 'evidence_comments_reference'
