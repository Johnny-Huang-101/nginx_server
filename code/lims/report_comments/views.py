...
from lims.models import ReportComments
from lims.forms import Attach, Import
from lims.report_comments.forms import Add, Update

from lims.view_templates.views import *

# Set item variables
item_type = 'Report Comments'
item_name = 'Report Comment'
...
blueprint = Blueprint('report_comments', __name__)
