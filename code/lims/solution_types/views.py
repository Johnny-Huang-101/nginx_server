...
from lims.models import SolutionTypes, AssayConstituents
from lims.solution_types.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.solution_types.functions import get_form_choices
from lims.view_templates.views import *

# Set item global variables
item_type = 'Solution Type'  # singular
item_name = 'Solution Types'
table = SolutionTypes
table_name = 'solution_types'
