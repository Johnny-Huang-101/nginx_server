...
from lims.models import AttachmentTypes
from lims.forms import Attach, Import
from lims.view_templates.views import *
from lims.attachment_types.forms import Add, Edit, Approve, Update
from lims.attachment_types.functions import get_form_choices
from lims.models import module_definitions
import pandas as pd

# Set item global variables
item_type = 'Attachment Type'  # singular
item_name = 'Attachment Types'
...
@login_required
def view_list():
    _view_list = view_items(table, item_name, item_type, table_name, order_by=['id'])
