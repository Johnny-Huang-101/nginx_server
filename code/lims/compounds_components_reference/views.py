...
from lims.models import CompoundsComponentsReference, Components
from lims.view_templates.views import *
from lims.forms import Attach, Import

# Set item global variables
item_type = 'Compound-Component Reference'
item_name = 'Compound-Component Reference'
table = CompoundsComponentsReference
table_name = 'compounds_components_reference'
