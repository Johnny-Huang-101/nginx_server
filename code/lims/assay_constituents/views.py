...
from lims.assay_constituents.forms import Add, Edit, Approve, Update

# Set item global variables
item_type = 'Assay Constituent Type'
item_name = 'Assay Constituent Types'  # ie display name in navbar, Modifications and Attachments tables
table = AssayConstituents
table_name = 'assay_constituents'
