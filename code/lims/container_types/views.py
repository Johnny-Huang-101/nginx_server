...
from lims.models import ContainerTypes
from lims.container_types.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'Container Type'
item_name = 'Container Types'
table = ContainerTypes
table_name = "container_types"
