...
from lims.booking_formats.forms import Add, Edit, Approve, Update

# Set item global variables
item_type = 'Booking Format'  # singular
item_name = 'Booking Formats'
table = BookingFormats
table_name = 'booking_formats'
