...
from lims.current_system_display.forms import Add, Edit, Approve, Update
from lims.current_system_display.functions import get_form_choices, process_form
...
# Set item variables
item_type = 'Current System Display'
item_name = 'Current System Display'
table = CurrentSystemDisplay
table_name = 'current_system_display'
name = 'id'
...
def view_list():
    ...
    _view_list = view_items(table, item_name, item_type, table_name, add_item_button=add_item_button)
