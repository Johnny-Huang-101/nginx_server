from lims.probes.functions import get_form_choices
from lims.locations.functions import set_location, models_iter, location_dict, get_location_display
from lims.models import Locations, Probes, Statuses
from lims.probes.forms import Add, Edit, Approve, Update
...
def add():
    ...
    if form.is_submitted():
        form.equipment_id.data = form.serial_number.data
