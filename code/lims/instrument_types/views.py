...
from lims.models import InstrumentTypes
from lims.instrument_types.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'Instrument Type'  # singular
item_name = 'Instrument Types'
