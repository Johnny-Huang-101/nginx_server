...
from lims.models import GeneralLabwareTypes
from lims.general_labware_types.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'General Labware Type'  # singular
item_name = 'General Labware Types'
table = GeneralLabwareTypes
table_name = 'general_labware_types'
