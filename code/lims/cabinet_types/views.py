...
from lims.models import CabinetTypes
from lims.cabinet_types.forms import Add, Edit, Approve, Update
from lims.forms import Attach, Import
from lims.view_templates.views import *

# Set item global variables
item_type = 'Cabinet Type'  # singular
item_name = 'Cabinet Types'
table = CabinetTypes
table_name = 'cabinet_types'
